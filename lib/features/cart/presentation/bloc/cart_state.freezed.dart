...
mixin _$CartState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Set<ShopItem> items) loaded,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Set<ShopItem> items)? loaded,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$CartLoaded implements CartLoaded {
  const _$CartLoaded({required final Set<ShopItem> items}) : _items = items;

  final Set<ShopItem> _items;
  @override
  Set<ShopItem> get items {
...
abstract class CartLoaded implements CartState {
  const factory CartLoaded({required final Set<ShopItem> items}) = _$CartLoaded;
